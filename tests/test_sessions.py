...
class TestSessionManagement:
    ...
    def test_session_chronological_order(self, storage_with_campaign):
        ...
        session3 = SessionNote(session_number=3, date=datetime.now(), title="Session 3", summary="summary 3")
        session1 = SessionNote(session_number=1, date=datetime.now(), title="Session 1", summary="summary 1") 
        session2 = SessionNote(session_number=2, date=datetime.now(), title="Session 2", summary="summary 2")
